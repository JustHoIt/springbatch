...
class TransactionReportTest {
  ...
  void testAdd() {
    ...
    TransactionReport report1 = TransactionReport.of(now, "ORDER_CREATION", 1L, 1000L, 1L, 1L, 1L,
        new BigDecimal(1), 100L,
        new HashSet<>(List.of("1")), new HashSet<>(List.of("1")),
        new HashSet<>(List.of("CREDIT_CARD")), 1L);

    TransactionReport report2 = TransactionReport.of(now, "ORDER_CREATION", 1L, 500L, 1L, 1L, 1L,
        new BigDecimal(1), 100L,
